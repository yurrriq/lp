...
\nwenddocs{}\nwbegincode{118}\sublabel{NWlJ9ZL-3P1OfB-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3P1OfB-1}}}\moddef{src/eliza.lisp~{\nwtagstyle{}\subpageref{NWlJ9ZL-3P1OfB-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
(in-package #:paip)
(defpackage #:paip.eliza
  (:\nwlinkedidentc{use}{NWlJ9ZL-3V5be-1} #:cl #:lisp-unit))
(in-package #:paip.eliza)

\LA{}eliza constants~{\nwtagstyle{}\subpageref{NWlJ9ZL-1rgAdm-1}}\RA{}

\LA{}Is the argument a list that starts with a given atom?~{\nwtagstyle{}\subpageref{NWlJ9ZL-26JY6E-1}}\RA{}

\LA{}simple-equal~{\nwtagstyle{}\subpageref{NWlJ9ZL-3DwGES-1}}\RA{}

\LA{}pat-match~{\nwtagstyle{}\subpageref{NWlJ9ZL-3nmfAz-1}}\RA{}

\LA{}variable-p~{\nwtagstyle{}\subpageref{NWlJ9ZL-1JbiwF-1}}\RA{}

\LA{}eliza binding functions~{\nwtagstyle{}\subpageref{NWlJ9ZL-3wKBbF-1}}\RA{}
\nwnotused{src/eliza.lisp}\nwidentuses{\\{{\nwixident{use}}{use}}}\nwindexuse{\nwixident{use}}{use}{NWlJ9ZL-3P1OfB-1}\nwendcode{}\nwbegindocs{119}\nwdocspar

\nwenddocs{}\nwbegincode{120}\sublabel{NWlJ9ZL-3DwGES-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3DwGES-1}}}\moddef{simple-equal~{\nwtagstyle{}\subpageref{NWlJ9ZL-3DwGES-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3P1OfB-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{simple-equal}{NWlJ9ZL-3DwGES-1} (x y)\nwindexdefn{\nwixident{simple-equal}}{simple-equal}{NWlJ9ZL-3DwGES-1}
  "Are x and y equal? (Don't check inside strings.)"
  (if (or (atom x) (atom y))
      (eql x y)
      (and (\nwlinkedidentc{simple-equal}{NWlJ9ZL-3DwGES-1} (first x) (first y))
           (\nwlinkedidentc{simple-equal}{NWlJ9ZL-3DwGES-1} (rest x) (rest y)))))
\nwused{\\{NWlJ9ZL-3P1OfB-1}}\nwidentdefs{\\{{\nwixident{simple-equal}}{simple-equal}}}\nwendcode{}\nwbegindocs{121}\nwdocspar

\nwenddocs{}\nwbegincode{122}\sublabel{NWlJ9ZL-3nmfAz-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3nmfAz-1}}}\moddef{pat-match~{\nwtagstyle{}\subpageref{NWlJ9ZL-3nmfAz-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3P1OfB-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{pat-match}{NWlJ9ZL-3nmfAz-1} (pattern input &optional (bindings \nwlinkedidentc{no-bindings}{NWlJ9ZL-1rgAdm-1}))\nwindexdefn{\nwixident{pat-match}}{pat-match}{NWlJ9ZL-3nmfAz-1}
  "Match pattern against input in the context of the bindings."
  (cond ((eq bindings \nwlinkedidentc{fail}{NWlJ9ZL-1rgAdm-1})          \nwlinkedidentc{fail}{NWlJ9ZL-1rgAdm-1})
        ((\nwlinkedidentc{variable-p}{NWlJ9ZL-1JbiwF-1} pattern)        (\nwlinkedidentc{match-variable}{NWlJ9ZL-3nmfAz-1} pattern input bindings))
        ((eql pattern input)         bindings)
        ((\nwlinkedidentc{segment-pattern-p}{NWlJ9ZL-3nmfAz-1} pattern) (\nwlinkedidentc{segment-match}{NWlJ9ZL-3nmfAz-1} pattern input bindings))
...
(defun \nwlinkedidentc{match-variable}{NWlJ9ZL-3nmfAz-1} (var input bindings)\nwindexdefn{\nwixident{match-variable}}{match-variable}{NWlJ9ZL-3nmfAz-1}
  "Does VAR match input? Uses (or updates) and returns bindings."
  (let ((binding (\nwlinkedidentc{get-binding}{NWlJ9ZL-3wKBbF-1} var bindings)))
    (cond ((not binding) (\nwlinkedidentc{extend-bindings}{NWlJ9ZL-3wKBbF-1} var input bindings))
          ((equal input (\nwlinkedidentc{binding-val}{NWlJ9ZL-3wKBbF-1} binding)) bindings)
          (t \nwlinkedidentc{fail}{NWlJ9ZL-1rgAdm-1}))))

(defun \nwlinkedidentc{segment-pattern-p}{NWlJ9ZL-3nmfAz-1} (pattern)\nwindexdefn{\nwixident{segment-pattern-p}}{segment-pattern-p}{NWlJ9ZL-3nmfAz-1}
  "Is this a segment matching pattern: ((?* var) . pat)"
  (and (consp pattern)
       (\nwlinkedidentc{starts-with}{NWlJ9ZL-26JY6E-1} (first pattern) '?*)))

(defun \nwlinkedidentc{segment-match}{NWlJ9ZL-3nmfAz-1} (pattern input bindings &optional (start 0))\nwindexdefn{\nwixident{segment-match}}{segment-match}{NWlJ9ZL-3nmfAz-1}
...
\nwenddocs{}\nwbegincode{126}\sublabel{NWlJ9ZL-1rgAdm-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-1rgAdm-1}}}\moddef{eliza constants~{\nwtagstyle{}\subpageref{NWlJ9ZL-1rgAdm-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3P1OfB-1}}\nwenddeflinemarkup
(defconstant \nwlinkedidentc{fail}{NWlJ9ZL-1rgAdm-1} nil\nwindexdefn{\nwixident{fail}}{fail}{NWlJ9ZL-1rgAdm-1}
  "Indicates \nwlinkedidentc{pat-match}{NWlJ9ZL-3nmfAz-1} failure")

(defconstant \nwlinkedidentc{no-bindings}{NWlJ9ZL-1rgAdm-1} '((t . t))\nwindexdefn{\nwixident{no-bindings}}{no-bindings}{NWlJ9ZL-1rgAdm-1}
  "Indicates \nwlinkedidentc{pat-match}{NWlJ9ZL-3nmfAz-1} success, with no variables.")
\nwused{\\{NWlJ9ZL-3P1OfB-1}}\nwidentdefs{\\{{\nwixident{fail}}{fail}}\\{{\nwixident{no-bindings}}{no-bindings}}}\nwidentuses{\\{{\nwixident{pat-match}}{pat-match}}}\nwindexuse{\nwixident{pat-match}}{pat-match}{NWlJ9ZL-1rgAdm-1}\nwendcode{}\nwbegindocs{127}\nwdocspar

\nwenddocs{}\nwbegincode{128}\sublabel{NWlJ9ZL-3wKBbF-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-3wKBbF-1}}}\moddef{eliza binding functions~{\nwtagstyle{}\subpageref{NWlJ9ZL-3wKBbF-1}}}\endmoddef\nwstartdeflinemarkup\nwusesondefline{\\{NWlJ9ZL-3P1OfB-1}}\nwenddeflinemarkup
(defun \nwlinkedidentc{get-binding}{NWlJ9ZL-3wKBbF-1} (var bindings)\nwindexdefn{\nwixident{get-binding}}{get-binding}{NWlJ9ZL-3wKBbF-1}
  "Find a (variable . value) pair in a binding list."
  (assoc var bindings))

(defun \nwlinkedidentc{binding-val}{NWlJ9ZL-3wKBbF-1} (binding)\nwindexdefn{\nwixident{binding-val}}{binding-val}{NWlJ9ZL-3wKBbF-1}
  "Get the value part of a single binding."
  (cdr binding))

(defun \nwlinkedidentc{lookup}{NWlJ9ZL-3wKBbF-1} (var bindings)\nwindexdefn{\nwixident{lookup}}{lookup}{NWlJ9ZL-3wKBbF-1}
  "Get the value part (for var) from a binding list."
  (\nwlinkedidentc{binding-val}{NWlJ9ZL-3wKBbF-1} (\nwlinkedidentc{get-binding}{NWlJ9ZL-3wKBbF-1} var bindings)))

(defun \nwlinkedidentc{extend-bindings}{NWlJ9ZL-3wKBbF-1} (var val bindings)\nwindexdefn{\nwixident{extend-bindings}}{extend-bindings}{NWlJ9ZL-3wKBbF-1}
  "Add a (var . value) pair to a binding list."
  (cons (cons var val)
        (if (eq bindings \nwlinkedidentc{no-bindings}{NWlJ9ZL-1rgAdm-1})
            nil
            bindings)))
\nwused{\\{NWlJ9ZL-3P1OfB-1}}\nwidentdefs{\\{{\nwixident{binding-val}}{binding-val}}\\{{\nwixident{extend-bindings}}{extend-bindings}}\\{{\nwixident{get-binding}}{get-binding}}\\{{\nwixident{lookup}}{lookup}}}\nwidentuses{\\{{\nwixident{no-bindings}}{no-bindings}}}\nwindexuse{\nwixident{no-bindings}}{no-bindings}{NWlJ9ZL-3wKBbF-1}\nwendcode{}\nwbegindocs{129}\nwdocspar

\chapter{Package}

\nwenddocs{}\nwbegincode{130}\sublabel{NWlJ9ZL-34miW3-1}\nwmargintag{{\nwtagstyle{}\subpageref{NWlJ9ZL-34miW3-1}}}\moddef{paip.asd~{\nwtagstyle{}\subpageref{NWlJ9ZL-34miW3-1}}}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
;;;; paip.asd
...
\nwixlogsorted{c}{{eliza binding functions}{NWlJ9ZL-3wKBbF-1}{\nwixu{NWlJ9ZL-3P1OfB-1}\nwixd{NWlJ9ZL-3wKBbF-1}}}%
\nwixlogsorted{c}{{eliza constants}{NWlJ9ZL-1rgAdm-1}{\nwixu{NWlJ9ZL-3P1OfB-1}\nwixd{NWlJ9ZL-1rgAdm-1}}}%
...
\nwixlogsorted{c}{{simple-equal}{NWlJ9ZL-3DwGES-1}{\nwixu{NWlJ9ZL-3P1OfB-1}\nwixd{NWlJ9ZL-3DwGES-1}}}%
